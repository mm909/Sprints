...
function addCircle() {
  ...
  var x = validArray[s].pos.x;
  var y = validArray[s].pos.y;

  var tempC = color(validArray[s].r,validArray[s].g,validArray[s].b)
  // var tempC = color(100,0,100)
  var valid = true;
  for (var i = 0; i < circles.length; i++) {
    var c = circles[i];
  ...
  if (valid) {
    circles.push(new Circle(x, y,tempC))
  }
